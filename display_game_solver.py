...
class SokobanDisplay:
    def __init__(self):
       ...
       # Boutons avec espacement de 20px entre eux
        self.button_bfs = pygame.Rect(200, 20, 100, 40)
        self.button_dfs = pygame.Rect(self.button_bfs.right + 20, 20, 100, 40)
        self.button_hint = pygame.Rect(self.button_dfs.right + 20, 20, 100, 40)
    ...
    def draw_game(self):
        ...
        info_x = self.screen.get_width() - 550
